 ...
 * @since 1.0.0
 */
public class SmsAdminAuthenticationFailureHandler implements AuthenticationFailureHandler {
	...
	public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response,
		...
		if (exception instanceof SecurityAuthenticationException ex && SecurityErrorCode.VerifyCodeIncorrect.equals(ex.getErrorCode())) {
