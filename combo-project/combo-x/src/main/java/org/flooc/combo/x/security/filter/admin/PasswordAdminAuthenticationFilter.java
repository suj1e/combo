package org.flooc.combo.x.security.filter.admin;

import static org.flooc.combo.x.security.constant.AuthUrlConstant.PASSWORD_ADMIN_LOGIN_DISPATCH_URL;
...
import org.flooc.combo.x.security.provider.admin.PasswordAdminAuthenticationToken;
...
public class PasswordAdminAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
	...
	private static final AntPathRequestMatcher DEFAULT_AUTHENTICATION_PATH = new AntPathRequestMatcher(
			PASSWORD_ADMIN_LOGIN_DISPATCH_URL);
