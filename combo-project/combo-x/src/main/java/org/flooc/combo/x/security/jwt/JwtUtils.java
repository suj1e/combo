package org.flooc.combo.x.security.jwt;
	...
	public static JwtTokenVerifyResult verifyToken(String keyId, String token) {
		try {
			...
			if (publicKey == null) {
				...
				return JwtTokenVerifyResult.invalid(SecurityExceptionEnum.TokenParseError);
			}
			...
			if (expired) {
				return JwtTokenVerifyResult.invalid(SecurityExceptionEnum.TokenExpired);
			}
