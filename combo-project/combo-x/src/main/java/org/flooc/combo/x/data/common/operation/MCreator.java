 ...
 */
@Slf4j
public class MCreator<M> implements Operation, Creator<M>, Handler<M>, Executor<M> {

	private MProcessor<M> modelProcessor;
	...
	public MCreator(MProcessor<M> modelProcessor) {
