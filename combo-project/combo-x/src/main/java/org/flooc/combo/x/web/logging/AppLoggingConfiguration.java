...
public class AppLoggingConfiguration implements EnvironmentAware {
  ...
  public AppLoggingConfiguration(String scan) {
    this.scan = scan;
  }
  ...
  @Bean
	...
	private Pointcut buildPointcut() {
		...
		return annotationPointcut.intersection(new AppLoggingPointcut(scan));
	}
	...
	static class AppLoggingPointcut implements MethodMatcher {
		...
		AppLoggingPointcut(String scanPackage) {
		...
		public boolean matches(@NonNull Method method, @NonNull Class<?> targetClass) {
			...
			return targetClass.getName().startsWith(scanPackage);
		}
